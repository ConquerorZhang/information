...
var eBF=_mz(z,'image',['class',38,'mode',1,'src',2],[],e,s,gg)
_(tAF,eBF)
var bCF=_n('text')
...
var oFF=_mz(z,'image',['class',44,'mode',1,'src',2],[],e,s,gg)
_(xEF,oFF)
var fGF=_n('text')
...
var oRF=_n('view')
_rz(z,oRF,'class',56,tOF,aNF,gg)
var oTF=_mz(z,'view',['class',57,'id',1],[],tOF,aNF,gg)
var fUF=_mz(z,'image',['class',59,'mode',1,'src',2],[],tOF,aNF,gg)
_(oTF,fUF)
var cVF=_n('view')
_rz(z,cVF,'class',62,tOF,aNF,gg)
var hWF=_n('view')
_rz(z,hWF,'class',63,tOF,aNF,gg)
var oXF=_oz(z,64,tOF,aNF,gg)
_(hWF,oXF)
_(cVF,hWF)
var cYF=_n('view')
_rz(z,cYF,'class',65,tOF,aNF,gg)
var oZF=_oz(z,66,tOF,aNF,gg)
_(cYF,oZF)
_(cVF,cYF)
_(oTF,cVF)
var l1F=_mz(z,'image',['bindtap',67,'class',1,'data-event-opts',2,'mode',3,'src',4],[],tOF,aNF,gg)
_(oTF,l1F)
_(oRF,oTF)
var a2F=_n('view')
_rz(z,a2F,'class',72,tOF,aNF,gg)
var t3F=_oz(z,73,tOF,aNF,gg)
_(a2F,t3F)
_(oRF,a2F)
var xSF=_v()
_(oRF,xSF)
if(_oz(z,74,tOF,aNF,gg)){xSF.wxVkey=1
var e4F=_n('view')
_rz(z,e4F,'class',75,tOF,aNF,gg)
var b5F=_v()
_(e4F,b5F)
var o6F=function(o8F,x7F,f9F,gg){
var hAG=_n('view')
var oBG=_n('text')
_rz(z,oBG,'class',80,o8F,x7F,gg)
var cCG=_oz(z,81,o8F,x7F,gg)
_(oBG,cCG)
_(hAG,oBG)
var oDG=_n('text')
_rz(z,oDG,'class',82,o8F,x7F,gg)
var lEG=_oz(z,83,o8F,x7F,gg)
_(oDG,lEG)
_(hAG,oDG)
_(f9F,hAG)
return f9F
...
b5F.wxXCkey=2
_2z(z,78,o6F,tOF,aNF,gg,b5F,'subItem','subIndex','subIndex')
_(xSF,e4F)
}
xSF.wxXCkey=1
_(ePF,oRF)
...
oLF.wxXCkey=2
_2z(z,54,lMF,e,s,gg,oLF,'item','index','index')
_(oLE,hIF)
var aFG=_mz(z,'view',['class',84,'hidden',1],[],e,s,gg)
var tGG=_mz(z,'chat-input',['bind:__l',86,'bind:blur',1,'bind:sendMessage',2,'data-event-opts',3,'focus',4,'placeholder',5,'vueId',6],[],e,s,gg)
_(aFG,tGG)
_(oLE,aFG)
var eHG=_mz(z,'uni-popup',['bind:__l',93,'bind:change',1,'data-event-opts',2,'maskClick',3,'show',4,'type',5,'vueId',6,'vueSlots',7],[],e,s,gg)
var bIG=_n('view')
_rz(z,bIG,'class',101,e,s,gg)
var oJG=_n('view')
_rz(z,oJG,'class',102,e,s,gg)
var xKG=_mz(z,'image',['class',103,'mode',1,'src',2],[],e,s,gg)
_(oJG,xKG)
var oLG=_n('text')
...
_(oJG,oPG)
_(bIG,oJG)
var oRG=_mz(z,'view',['bindtap',112,'class',1,'data-event-opts',2],[],e,s,gg)
var lSG=_mz(z,'uni-icons',['bind:__l',115,'color',1,'size',2,'type',3,'vueId',4],[],e,s,gg)
_(oRG,lSG)
_(bIG,oRG)
_(eHG,bIG)
_(oLE,eHG)
